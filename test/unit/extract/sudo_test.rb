...
class SudoTest < ActiveSupport::TestCase
  context "auth.log.sudo" do
    setup do
      @auth = "evidence/sanitized_log/auth.log.sudo"
    end
    ...
    should "have a valid SHA1" do
      assert_equal "7cf48097ceb945a95948ab9cce14b9d74c1a0f85", Digest::SHA1.hexdigest(open(@auth, "r").read)
    end
